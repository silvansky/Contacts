...
Build requirements: subversion build-essential devscripts fakeroot debhelper openssl libqtwebkit-dev libqt4-dev libx11-dev zlib1g-dev libidn11-dev
...
# Version
[ -d .svn ] && svn_version=`svnversion -n` || svn_version=""
...
DEBEMAIL="Rambler Team <support@rambler.ru>" dch --create --package ramblercontacts --force-distribution -D "unstable" -v "${VERSION}-1" "Release" || exit 1
