...
pj_status_t pjmedia_format_id_to_PixelFormat(pjmedia_format_id fmt_id, enum PixelFormat *pixel_format)
{
	unsigned i;
...
pj_status_t PixelFormat_to_pjmedia_format_id(enum PixelFormat pf, pjmedia_format_id *fmt_id)
{
	unsigned i;
	for (i=0; i<PJ_ARRAY_SIZE(ffmpeg_fmt_table); ++i)
	{
