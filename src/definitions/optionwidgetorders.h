...
#define OWO_NOTIFICATIONS_CONTACT_ADDED           350
#define OWO_NOTIFICATIONS_SUBSCRIPTIONS           360
#define OWO_NOTIFICATIONS_CHATSTATE               370
#define OWO_NOTIFICATIONS_CONNECTION              380
#define OWO_NOTIFICATIONS_BIRTHDAY                390
