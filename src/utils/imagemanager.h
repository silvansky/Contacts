...
public:
	...
	static QImage squared(const QImage & image, int size, bool canCrop = false);
	static QImage roundSquared(const QImage & image, int size, int radius, bool canCrop = false);
